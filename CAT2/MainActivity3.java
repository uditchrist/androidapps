...
public class MainActivity3 extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> spin_adapter = new ArrayAdapter<String>(MainActivity3.this, android.R.layout.simple_spinner_item, type);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(MainActivity3.this,"Thanks you! Your Train booking has been confirmed. ",Toast.LENGTH_LONG).show();
            }
        });
